...
public class CollectorController extends BaseController{
    ...
    public @ResponseBody Collector createCollector(@ApiParam(value = "collector to create", name = "collector", required = true) @RequestBody Collector collector)
    ...
    public @ResponseBody Collector readCollector(@ApiParam(value = "collector to read", name = "id", required = true) @PathVariable Long id) throws NotFoundException {
